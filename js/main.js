...
function checkAnswer(){
	dino.remove();
	dinoHtml = `<div class="dino_Ar"></div>`;
	game.innerHTML = game.innerHTML + dinoHtml;	
	ohota();
...
const game =  document.querySelector('.dino');
const dino = document.querySelector('.dino_Ar');
...
let isAlive = setInterval (function(){
    ...
    let dinoTop =   parseInt(window.getComputedStyle(dino).getPropertyValue('right'));
